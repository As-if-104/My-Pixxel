...
function CanvasEditor({ project }) {
  ...
  useEffect(() => {
    ...
    if (!canvasRef.current || !project || canvasEditor || isInitialized.current)
      return;
  ...
  }, [project?._id]); // ← Changed dependency to only project._id
  ...
  }, [canvasEditor, project?._id]); // ← Added project._id
