...
export default function EditorPage() {
  ...
  console.log("useParams:", params); // Debug log
  console.log("usePathname:", pathname); // Debug log

  console.log("EditorPage - projectId:", projectId); // Debug log

  const [canvasEditor, setCanvasEditor] = useState(null);
  const [processingMessage, setProcessingMessage] = useState(null);
  const [activeTool, setActiveTool] = useState("resize");

  // Get project data - only query if projectId exists
  const {
    data: project,
    isLoading,
    error,
  ...
  console.log("Query result:", { project, isLoading, error }); // Debug log
